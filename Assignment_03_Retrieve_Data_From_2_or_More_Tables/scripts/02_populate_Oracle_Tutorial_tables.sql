...
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values (14,'Elliot','Brooks','elli brooks@example.com','515.124.4567', STR_TO_DATE('07-DEC-16','%d-%b-%y'),9,'Accountant');
